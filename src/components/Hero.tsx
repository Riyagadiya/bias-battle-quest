      ...
      <div className="container mx-auto relative">
        <div className="max-w-4xl mx-auto text-center">
          <motion.h1
            ...
            className="font-domine font-bold text-5xl md:text-6xl lg:text-[64px] leading-[72px] tracking-[-3%] mb-6"
          >
            Cognitive Biases:
            <br /> 
          ...
          <motion.p
            ...
            className="font-normal text-xl md:text-2xl text-[24px] leading-[32px] tracking-[-3%] text-muted-foreground max-w-2xl mx-auto mb-10"
          >
